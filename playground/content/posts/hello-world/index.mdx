...
date: 2016-02-20
description: "这是博客的第一篇文章，用于测试本 Tufte 风格博客的基本排版元素，包括中英文混排、边注、引用、代码块、图片、表格、Ruby 注音等。"
math: true
tags: ["测试", "tufte"]
toc: true
---
...
```go {lineno=true,hl_lines=["202-205"],linenostart=199}
package main
...
<Figure
  ...
  alt="普通图片"
  caption="From Edward Tufte"
  credit="Visual Display of Quantitative Information, page 92."
  creditUrl="https://edwardtufte.github.io/tufte-css/"
/>

<MarginFigure
    id="mf1"
    src="https://edwardtufte.github.io/tufte-css/img/rhino.png"
    alt="F.J. Cole, “The History of Albrecht Dürer’s Rhinoceros in Zooological Literature,”"
    caption="Science, Medicine, and History: Essays on the Evolution of Scientific Thought and Medical Practice (London, 1953)"
/>
