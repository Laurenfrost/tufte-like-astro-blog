...
import Blockquote from '@laurenfrost/astro-tufte/components/Blockquote.astro';
import Cite from '@laurenfrost/astro-tufte/components/Cite.astro';
import Figure from '@laurenfrost/astro-tufte/components/Figure.astro';
import MarginNote from '@laurenfrost/astro-tufte/components/MarginNote.astro';
import MarginFigure from '@laurenfrost/astro-tufte/components/MarginFigure.astro';
import Ruby from '@laurenfrost/astro-tufte/components/Ruby.astro';
import Sidenote from '@laurenfrost/astro-tufte/components/Sidenote.astro';

## 唐代诗人孟浩然的《春晓》

<MarginFigure id="mhr" src="./Meng_Haoran.jpg" alt="《孟浩然》" caption="唐代诗人孟浩然（689/691–740）" credit="画像出典：Wikipedia" creditUrl="https://en.wikipedia.org/wiki/Meng_Haoran" />
